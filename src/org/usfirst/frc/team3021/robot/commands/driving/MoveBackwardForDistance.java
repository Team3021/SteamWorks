...
public class MoveBackwardForDistance extends DriveCommand {
	
	protected double speed = 0;
	protected double desiredDistance = 0;
	
	public MoveBackwardForDistance() {
		super();
	...
	protected void initialize() {
		System.out.println("Start moving backwards for distance : " + desiredDistance);
	...
	@Override
	protected void end() {
		System.out.println("Ending moving backwards for distance : " + desiredDistance);
	}
